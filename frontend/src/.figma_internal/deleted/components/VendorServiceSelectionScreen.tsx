  ...
  const renderServiceCard = (service: Service, isSelected: boolean, size: 'large' | 'small' = 'large') => {
    ...
    return (
      <motion.button
        ...
        className={`${cardClass} rounded-xl border-2 transition-all duration-200 relative ${
          isSelected 
      ...
      >
        ...
        {/* Service Icon */}
        <div 
          className={`${size === 'large' ? 'mb-3' : 'mb-2'} flex justify-center`}
        ...
        {/* Service Name */}
        <h3 
          className={`${size === 'large' ? 'text-[16px]' : 'text-[14px]'} font-medium text-center mb-2`}
          style={{ 
            color: '#1D1D1F',
