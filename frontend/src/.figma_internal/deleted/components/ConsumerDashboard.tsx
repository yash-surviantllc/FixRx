...
export function ConsumerDashboard({ userName = 'Sarah', userLocation = 'San Francisco, CA', onViewContractor, onRateService, onViewNotifications, onSeeAllRecommendations }: ConsumerDashboardProps) {
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <motion.button
              ...
              className="relative p-2 rounded-full bg-gray-50 hover:bg-gray-100 transition-colors duration-200"
            >
      ...
      <div className="px-5 mb-6">
        ...
        >
          ...
          <button 
            ...
            className="flex items-center space-x-1 text-blue-500 hover:opacity-70 transition-opacity duration-200"
          >
            <span 
              className="text-[14px]"
              style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", system-ui, sans-serif' }}
        ...
        <div className="space-y-4">
          {filteredContractors.length > 0 ? (
            ...
            >
              ...
              <button 
                className="text-[16px] text-blue-500 hover:opacity-70 transition-opacity duration-200"
                style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", system-ui, sans-serif' }}
              >
