    ...
    <div className="min-h-screen w-full bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-100 px-5 pt-5 pb-4">
        <div className="flex items-center mb-4">
          ...
          >
            {invitationType === 'contractors' ? 'Add Contractors' : 'Invite Friends'}
          </span>
        </div>
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              placeholder={invitationType === 'contractors' ? "Search for contractors" : "Search for friends"}
            ...
            <button
              ...
              className={`absolute right-4 top-1/2 transform -translate-y-1/2 w-8 h-8 rounded-full transition-all duration-200 flex items-center justify-center ${
        ...
        <div className="flex space-x-2 overflow-x-auto">
          {[
            ...
            <button
              ...
              className={`px-4 py-2 h-9 rounded-full whitespace-nowrap transition-all duration-200 flex items-center justify-center ${
      ...
      {selectedContacts.size > 0 && (
        <div className="bg-blue-50 px-5 py-3 border-b border-blue-100">
          <div className="flex items-center justify-between">
            ...
            >
{selectedContacts.size} {invitationType === 'contractors' ? 'contractor' : 'friend'}{selectedContacts.size === 1 ? '' : 's'} selected
            </span>
            
            <div className="flex items-center space-x-3">
              <button
                onClick={() => setShowSelectedPreview(!showSelectedPreview)}
                className="flex items-center justify-center space-x-1 text-blue-500 hover:text-blue-600 transition-colors duration-200 h-8 px-2 rounded"
              >
                <span 
                  className="text-[14px] font-medium"
                  style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", system-ui, sans-serif' }}
              ...
              <button
                ...
                className="text-[14px] text-gray-500 hover:text-gray-700 transition-colors duration-200 h-8 px-2 rounded flex items-center justify-center"
                style={{ 
                  fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", system-ui, sans-serif',
                  fontWeight: 500
                }}
      ...
      <div className="bg-white px-5 py-2 border-b border-gray-100 flex items-center justify-between">
        <button
          ...
          className="text-[14px] text-blue-500 hover:text-blue-600 transition-colors duration-200 h-8 px-2 rounded flex items-center justify-center"
          style={{ 
            fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", system-ui, sans-serif',
            fontWeight: 500
          }}
