...
export function InvitationPreviewScreen({ 
  ...
  const generateMessage = (contactName: string) => {
    if (invitationType === 'friends') {
      // Friend invitation message
      let baseMessage = `Hi ${contactName}! I've been using FixRx to find trusted contractors through my network. It's been amazing! You should join and build your own trusted contractor network.`;
      
      baseMessage += ` Download: fixrx.com/app`;
      
      if (includeReferralCode) {
        baseMessage += ` Use my code: ${referralCode}`;
      }
      
      return baseMessage;
    } else {
      // Contractor invitation message
      ...
      <div className="bg-white border-b border-gray-100 px-5 pt-5 pb-4">
        <div className="flex items-center mb-4">
          <motion.button
            ...
            onClick={onBack}
            className="w-11 h-11 rounded-full hover:bg-gray-100 transition-colors duration-200 mr-3 flex items-center justify-center"
          >
        ...
        >
          ...
          >
            {invitationType === 'contractors' ? 'Review contractor invitations' : 'Review friend invitations'}
          </h1>
          ...
          >
            {invitationType === 'contractors' 
              ? 'Customize your contractor invitation message' 
              : 'Customize your friend invitation message'}
          </p>
        </motion.div>
      </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
            ...
            <div className="mb-4">
              <button
                ...
                className="flex items-center justify-between w-full text-left h-12 px-4 rounded-lg hover:bg-gray-50 transition-colors duration-200"
              >
                ...
                {showPersonalNote && (
                  ...
                  >
                    <textarea
                      ...
                      placeholder={invitationType === 'contractors' 
                        ? "Great working with you on the Johnson project!" 
                        : "You always find the best contractors - this will be perfect for you!"}
        ...
        >
          <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
            ...
            <div className="space-y-4">
              {/* Include Profile Info - Only for contractor invitations */}
              {invitationType === 'contractors' && (
                <div className="flex items-center justify-between">
                  <div>
                    <h4 
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  >
                    Code: {referralCode} {invitationType === 'friends' ? '(Gives you both credits)' : ''}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="flex items-center justify-center space-x-1 text-blue-500 hover:text-blue-600 transition-colors duration-200 h-8 px-3 rounded"
              >
                <span 
                  ...
                  {activeContacts.map(contact => (
                    <div key={contact.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-full hover:bg-gray-200 transition-colors duration-200 flex items-center justify-center"
                      >
