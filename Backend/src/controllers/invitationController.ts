      ...
      if (type === 'EMAIL') {
        const html = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>Hi there,</p>
            <p><strong>${invitation.sender.firstName} ${invitation.sender.lastName}</strong> has invited you to join FixRx!</p>
            ${invitation.message ? `<p><em>"${invitation.message}"</em></p>` : ''}
            <p>FixRx connects you with trusted service providers in your area.</p>
            <p style="margin: 30px 0;">
              <a href="https://fixrx.com/download?invitation=${invitation.id}" 
        ...
        await QueueService.addEmailJob({
          to: recipientEmail!,
          subject: `${invitation.sender.firstName} invited you to join FixRx!`,
          html,
        });
      } else if (type === 'SMS') {
      ...
      if (type === 'EMAIL' && recipient.email) {
        const html = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>You've been invited to join FixRx!</p>
            ${invitation.message ? `<p><em>"${invitation.message}"</em></p>` : ''}
            <p>FixRx connects you with trusted service providers in your area.</p>
            <p style="margin: 30px 0;">
              <a href="https://fixrx.com/download?invitation=${invitation.id}" 
